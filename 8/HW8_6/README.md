...
[ ansible_file collection repository ](https://github.com/Alex-Elfman/my_own_collection.git)

#### Installation

```console
ansible-galaxy collection install git+https://github.com/Alex-Elfman/my_own_collection.git
```
